...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_tb_usd_2.setText(QCoreApplication.translate("Dialog", u"JD CORPCOMPANY Swapper", None))
        ...
        self.label_title_bar_top.setText(QCoreApplication.translate("Dialog", u"JD CORPCOMPANY", None))
#if QT_CONFIG(tooltip)
